...
// Enable Contention Free Period code
//#define DOT11_ENABLE_CFP 1
...
#define DOT11_TX_CHANSWITCH_DELAY 3     //time (seconds) between TX node channel switch when queue is full
...
#define DOT11_MAC_STATS_LABEL           "802.11MAC"
#define DOT11_DCF_STATS_LABEL           "802.11DCF"
//--------------------HCCA-Updates Start---------------------------------//
#define DOT11e_HC_DELIVERY_MODE_DEFAULT    DOT11e_HC_POLL_AND_DELIVER
#define DOT11e_HCCA_LOWEST_PRIORITY 4
#define DOT11e_HCCA_TSBUFFER_SIZE 7
#define DOT11e_HCCA_TOTAL_TSQUEUE_SUPPORTED (DOT11e_HCCA_TSBUFFER_SIZE - \
...
// /**
// CONSTANT    :: DOT11e_MAC_STATS_LABEL : 802.11eMAC
// DESCRIPTION :: Statistic Label
// **/
#define DOT11e_MAC_STATS_LABEL           "802.11eMAC"

// /**
// CONSTANT    :: DOT11e_NUMBER_OF_AC : 4
// DESCRIPTION :: No of Access Category
// **/
#define DOT11e_NUMBER_OF_AC             4

// /**
// CONSTANT    :: DOT11e_INVALID_AC :  -1
// DESCRIPTION :: Invalid Access Category index
// **/
#define DOT11e_INVALID_AC              -1

// /**
// CONSTANT    :: DOT11e_AC_BK       :  0
// DESCRIPTION :: Background traffic Access Category index
// **/
#define DOT11e_AC_BK                    0

// /**
// CONSTANT    :: DOT11e_AC_BE       :  1
// DESCRIPTION :: Best effort traffic Access Category index
// **/
#define DOT11e_AC_BE                    1

// /**
// CONSTANT    :: DOT11e_AC_VI       :  2
// DESCRIPTION :: Video traffic Access Category index
// **/
#define DOT11e_AC_VI                    2

// /**
// CONSTANT    :: DOT11e_AC_VO       :  3
// DESCRIPTION :: Voice traffic Access Category index
// **/
...
// /**
// CONSTANT    :: DOT11e_802_11b_AC_BK_AIFSN : 7
// DESCRIPTION :: Background traffic Arbitary InterFrame Sequence
// **/
#define DOT11e_802_11b_AC_BK_AIFSN      7

// /**
// CONSTANT    :: DOT11e_802_11b_AC_BE_AIFSN :  3
// DESCRIPTION :: Best effort traffic Arbitary InterFrame Sequence
// **/
#define DOT11e_802_11b_AC_BE_AIFSN      3

// /**
// CONSTANT    :: DOT11e_802_11b_AC_VI_AIFSN :  2
// DESCRIPTION :: Video traffic Arbitary InterFrame Sequence
// **/
#define DOT11e_802_11b_AC_VI_AIFSN      2

// /**
// CONSTANT    :: DOT11e_802_11b_AC_VO_AIFSN  :  2
// DESCRIPTION :: Voice traffic Arbitary InterFrame Sequence
// **/
...
// /**
// CONSTANT    :: DOT11e_802_11b_AC_BK_TXOPLimit  :  0
// DESCRIPTION :: Background traffic Transmission Opportunity Limit
// **/
#define DOT11e_802_11b_AC_BK_TXOPLimit  0

// /**
// CONSTANT    :: DOT11e_802_11b_AC_BE_TXOPLimit  :  0
// DESCRIPTION :: Best effort Transmission Opportunity Limit
// **/
#define DOT11e_802_11b_AC_BE_TXOPLimit  0

// /**
// CONSTANT    :: DOT11e_802_11b_AC_VI_TXOPLimit : 6.016 * MILLI_SECOND
// DESCRIPTION :: Video traffic Transmission Opportunity Limit
// **/
#define DOT11e_802_11b_AC_VI_TXOPLimit  (6016 * MICRO_SECOND)

// /**
// CONSTANT    :: DOT11e_802_11b_AC_VO_TXOPLimit : 3.008 * MILLI_SECOND
// DESCRIPTION :: Voice traffic Transmission Opportunity Limit
// **/
...
//#define DOT11_DATA_RATE_ADJUSTMENT_TIME  (600 * SECOND)
...
struct DOT11_FrameInfo
{
    ...
    DOT11_FrameInfo()
        :   msg(NULL), frameType(DOT11_CF_NONE /* Reserved frame type */),
            insertTime(0)
    {
...
typedef struct struct_mac_dot11_data_rate_entry_t {
    ...
    struct struct_mac_dot11_data_rate_entry_t* next;
} DOT11_DataRateEntry;
...
// /**
// STRUCT      :: DOT11e_QoSControl
// DESCRIPTION :: Structure to hold QoS control filed related information
// **/
typedef struct {
...
// /**
// STRUCT      :: DOT11e_ACParameterRecordFields
// DESCRIPTION :: Structure to hold Access Category's records
// **/
typedef struct {
...
// /**
// STRUCT      :: DOT11e_QosInfoField
// DESCRIPTION :: Structure to hold QoS related informaton
// **/
typedef struct {
...
// /**
// STRUCT      :: DOT11e_EDCAParameterSet
// DESCRIPTION :: Structure to hold EDCF Parameter Set
// **/
typedef struct {
...
// /**
// STRUCT      :: DOT11e_QBSSLoadElement
// DESCRIPTION :: Structure to hold QoS enable Base Stations load elements
// **/
typedef struct {
...
typedef struct {
    ...
    char              FCS[2];       //      4         4 //Changed temp to match stats
...
// /**
// STRUCT      :: AccessCatagoryData
// DESCRIPTION :: Structure to hold Access Category related information
// **/
...
//---------------------------Power-Save-Mode-Updates---------------------//
// /**
// STRUCT      :: struct_mac_dot11_AttachedNodeList
// DESCRIPTION :: Structure to hold attach node information in IBSS mode
// **/
...
// /**
// STRUCT      :: struct_mac_dot11_ReceivedATIMFrameList
// DESCRIPTION :: Structure to hold receive ATIM frame information in IBSS mode
// **/
...
// -------------------------------------------------------------------------
// /**
// STRUCT      :: DOT11_SignalMeasurementInfo
...
// /**
// STRUCT      :: DOT11_ApInfo
// DESCRIPTION :: The information of an AP maintained at STA
// **/
...
//---------------------DOT11e--Updates------------------------------------//
    ...
    DOT11e_ACData    ACs[DOT11e_NUMBER_OF_AC];
    int currentACIndex;
...
//---------------------------Power-Save-Mode-End-Updates-----------------//
            ...
            if (*frame_type == DOT11_QOS_DATA)
            {
                printf("%3u\t %6s\t %5d\t %20s\t %19s\t %20s\t %2d\t %2d\t %2d|%2d\t %s (%s)\n",
                    ...
                    buf1,
                    hdr1->duration,
                    srcAdd,//hdr1->sourceAddr,
                    destAdd,//hdr1->destAddr,
                    addr3,//hdr1->address3,
                    hdr1->seqNo,
                    hdr1->fragId,
                    hdr1->qoSControl.TID,
...

            {
                printf("%3u\t %6s\t %5d\t %19s\t %19s\t %19s\t %2d\t %2d\t %2d|%2d\t %s (%s)\n",
                    ...
                    buf1,
                    hdr2->duration,
                    srcAdd,//hdr2->sourceAddr,
                    destAdd,//hdr2->destAddr,
                    addr3,//hdr2->address3,
                    hdr2->seqNo,
                    hdr2->fragId,
                    -1, -1,
...
// /**
// FUNCTION   :: MacDot11IsACsHasMessage
// LAYER      :: MAC
// PURPOSE    ::
// PARAMETERS ::
// + node      : Node* : Pointer to the node
...
// RETURN     :: BOOL : TRUE or FALSE
// **/
static BOOL MacDot11IsACsHasMessage(Node* node, MacDataDot11* dot11)
{
...
// /**
// FUNCTION   :: MacDot11IsAssociatedWithQAP
// LAYER      :: MAC
// PURPOSE    ::
// PARAMETERS ::
// + node      : Node* : Pointer to the node
...
// LAYER      :: MAC
// PURPOSE    ::To set the Current message varriables
// PARAMETERS ::
// + node      : Node* : Pointer to the node
// + dot11     : MacDataDot11* : Pointer to the MacData structure
// RETURN     :: void : NULL
